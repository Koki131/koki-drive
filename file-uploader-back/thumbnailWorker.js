...
console.log('Thumbnail Worker process started.');
...
const processor = async (job) => {
    ...
    try {
        ...
        console.log(`[Thumbnail Worker] Job ${job.id} complete. Preview for file ${fileId} at ${previewPath}`);
        ...
        console.error(`[Thumbnail Worker] Job ${job.id} failed for fileId ${fileId}:`, err);
